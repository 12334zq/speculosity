...
data_a = roughness100.load(root=root, set64=True, classes='A')
data_b = roughness100.load(root=root, set64=True, classes='B', test_ratio=1)
input_shape = (64, 64, 1)
nb_classes = 6

# Parameters
load_model_name = "./../data/models/roughness100_64p_A"
save_model_name = "./../data/models/roughness100_64p_A"
load = True
save = False
...
model.fit(x=data_a.train.data,
          y=data_a.train.labels,
          batch_size=256,
          epochs=64,
